...
class HttpModule {
    ...
    fun provideLogger(): Logger =
        if (BuildConfig.PRINT_HTTP_LOGS) LoggerFactory.getLogger("http") else NOPLogger.NOP_LOGGER
    ...
    fun provideAppInterceptor(context: Context) =
        if (BuildConfig.USE_FAKE_INTERCEPTOR) FakeInterceptor(context) else GeneralInterceptor()
